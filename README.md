...
![Hive](https://img.shields.io/badge/Hive-Local_Storage-FF6F00?style=for-the-badge&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0id2hpdGUiIGQ9Ik0xMiAyQzYuNDggMiAyIDYuNDggMiAxMnM0LjQ4IDEwIDEwIDEwIDEwLTQuNDggMTAtMTBTMTcuNTIgMiAxMiAyeiIvPjwvc3ZnPg==&logoColor=white)
![Riverpod](https://img.shields.io/badge/Riverpod-State_Management-00C4B4?style=for-the-badge&logo=flutter&logoColor=white)
...
├─────────────────────────────────────────────────────────────────────────────────────┤
│  ┌─────────────────┐    ┌──────────────────┐    ┌─────────────────┐              │
│  │  TaskProvider   │    │  AuthProvider    │    │  ThemeProvider  │              │
│  │ - Task CRUD     │    │ - Authentication │    │ - Theme mode    │              │
│  │ - Filtering     │    │ - User state     │    │ - Dark/Light    │              │
│  │ - Statistics    │    │ - Login/Logout   │    │                 │              │
│  └─────────────────┘    └──────────────────┘    └─────────────────┘              │
│           │                       │                       │                       │
│           └───────────────────────┼───────────────────────┘                       │
│                                   │                                               │
...
│  │  │ • toggleTask(String id) - Mark complete/incomplete                     │ │  │
│  │  │ • getTasksForDate(DateTime) - Filter by date                           │ │  │
...
│  │  │ • updateProfile(User) - Modify user details                            │ │  │
│  │  │ • updateProfileImage(File) - Update profile photo                      │ │  │
│  │  └────────────────────────────────────────────────────────────────────────┘ │  │
│  └──────────────────────────────────────────────────────────────────────────────┘  │
│                                   │                                                 │
└─────────────────────────────────────────────────────────────────────────────────────┘
...
│  │  │                        tasks_box                                     │  │  │
│  │  │  ┌────────────────────────────────────────────────────────────────┐  │  │  │
│  │  │  │ Key-Value Store (String ID → Task Object)                      │  │  │  │
│  │  │  │                                                                │  │  │  │
│  │  │  │ Task {                                                         │  │  │  │
│  │  │  │   id: String                                                   │  │  │  │
│  │  │  │   title: String                                                │  │  │  │
...
│  │  │  │   category: TaskCategory (work|personal|health|education...)  │  │  │  │
│  │  │  │   userId: String                                               │  │  │  │
...
│  │  │                        users_box                                     │  │  │
│  │  │  ┌────────────────────────────────────────────────────────────────┐  │  │  │
│  │  │  │ Key-Value Store (String ID → User Object)                      │  │  │  │
│  │  │  │                                                                │  │  │  │
│  │  │  │ User {                                                         │  │  │  │
│  │  │  │   id: String                                                   │  │  │  │
│  │  │  │   email: String                                                │  │  │  │
...
│  │  ┌──────────────────────────────────────────────────────────────────────┐  │  │
│  │  │                    Type Adapters (Hive)                              │  │  │
│  │  │  - TaskAdapter (typeId: 0) - Task serialization                     │  │  │
│  │  │  - TaskCategoryAdapter (typeId: 1) - Category enum serialization    │  │  │
│  │  │  - TaskPriorityAdapter (typeId: 3) - Priority enum serialization    │  │  │
│  │  │  - UserAdapter (typeId: 4) - User serialization                     │  │  │
│  │  └──────────────────────────────────────────────────────────────────────┘  │  │
│  └─────────────────────────────────────────────────────────────────────────────┘  │
│                                                                                     │
│  ┌─────────────────────────────────────────────────────────────────────────────┐  │
...
│  │  - Hive boxes stored as binary files                                       │  │
...
User Interaction → UI Screens → Riverpod Providers → StateNotifiers → Hive Database
                                ↓                                            ↑
                          State Updates ←────────────────────────────────────┘
                                ↓
...
<img src="assets/screenshots/today-screen.png" alt="Today Screen" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
<br><strong>🏠 Today Screen</strong>
<br><small>Daily task overview with progress tracking</small>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/tasks-list.png" alt="Tasks List" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
<br><strong>📋 Tasks List</strong>
<br><small>All tasks with filtering and organization</small>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/calendar-view.png" alt="Calendar" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<tr>
<td align="center" width="33%">
<img src="assets/screenshots/add-task.png" alt="Add Task" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
<br><strong>✏️ Add Task</strong>
<br><small>Comprehensive task creation interface</small>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/profile.png" alt="Profile" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
<br><strong>👤 Profile</strong>
<br><small>User profile with productivity analytics</small>
</td>
<td align="center" width="33%">
<img src="assets/screenshots/dark-mode.png" alt="Dark Mode" width="250" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://github.com/NshutiYvan10/todo_app/releases/download/v1.0.0/flutter-todo-app-v1.0.0.apk" alt="QR Code for APK Download" width="200" height="200" style="border: 2px solid #ddd; border-radius: 8px;">
...
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Storage-50MB-blue?style=for-the-badge&logo=harddisk&logoColor=white" alt="Storage"/>
<br><strong>50MB Space</strong>
<br><small>Available Storage</small>
</td>
<td align="center" width="25%">
<img src="https://img.shields.io/badge/RAM-1GB+-orange?style=for-the-badge&logo=memory&logoColor=white" alt="RAM"/>
<br><strong>1GB+ RAM</strong>
<br><small>2GB Recommended</small>
</td>
<td align="center" width="25%">
<img src="https://img.shields.io/badge/Internet-Optional-yellow?style=for-the-badge&logo=wifi&logoColor=white" alt="Internet"/>
...
[![Hive](https://img.shields.io/badge/Data-Hive-FF6F00?style=for-the-badge&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0id2hpdGUiIGQ9Ik0xMiAyQzYuNDggMiAyIDYuNDggMiAxMnM0LjQ4IDEwIDEwIDEwIDEwLTQuNDggMTAtMTBTMTcuNTIgMiAxMiAyeiIvPjwvc3ZnPg==&logoColor=white)](https://docs.hivedb.dev/)
